...
if __name__ == '__main__':
    mod_a = ModA()
    mod_b = ModB()
    BindManager.bind(mod_a, 'data', mod_b, 'data', BindType.ONE_WAY, (hex_str_to_ascii, None))

    mod_a.data = '31 32'
    print(f'mod_b.data: {mod_b.data}')

    BindManager.change_converter(mod_a, 'data', mod_b, 'data', BindType.ONE_WAY, (hex_to_bytes, None))
    mod_a.data = '31 32'
    print(f'mod_b.data: {mod_b.data}')